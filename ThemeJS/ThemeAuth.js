function setTheme() {
    ...
    const elementsImportantButton = document.querySelectorAll(
        ".to-change-important-button"
    );
    ...
    for (const element of elementsImportantButton) {
        element.classList.toggle("dark-theme-important-button");
    }
}
